...
public class TestObjectOrOptionUtils
{
    @Test
    public void testGetHighchartsPackageName()
    {
        ...
        // When
        String highchartsPackageName = ObjectOrOptionUtils.getPackageName(optionSpec);
    ...
    public void testIsRoot()
    {
        ...
        // When
        boolean isRoot = ObjectOrOptionUtils.isRoot(optionSpec);
        boolean isRoot2 = ObjectOrOptionUtils.isRoot(optionSpec2);
