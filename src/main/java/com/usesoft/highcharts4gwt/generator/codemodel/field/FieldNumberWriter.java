...
{
    public FieldNumberWriter(JCodeModel codeModel, JDefinedClass jClass, String className)
    {
    ...
    {
        JsoFieldHelper.addGetterSetterDeclaration(fieldName, Number.class, getJclass(), getCodeModel());
        return null;
    }
