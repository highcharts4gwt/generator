package com.usesoft.highcharts4gwt.annotation;
...
/**
 * This annotation can be applied to a package or class to indicate that the classes' fields in that element are nonnull by default unless there is
 * <ul>
